<?php /* Smarty version Smarty-3.1.16, created on 2017-05-11 08:03:01
...
">
							...
							<!--<fieldset style="width:48%; float:left;">
								<label>出处</label>
								<input type="text" name="from" style="width:92%;" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['fromip'])===null||$tmp==='' ? '' : $tmp);?>
">
